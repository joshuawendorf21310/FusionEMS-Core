...
Summary:
- Added AI hardening domain (`AiRun`, `AiPolicy`) with provider abstraction and billing analysis endpoint.
- Added structured AI output schema validation and explicit `requires_human_confirmation=true` responses.
