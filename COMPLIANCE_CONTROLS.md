...
- AI responses are structured and validated before persistence/use; invalid outputs are rejected.
- Billing analysis endpoint returns suggestions only and never auto-writes chart/legal records.
- Human confirmation remains required for any downstream chart-affecting action.
