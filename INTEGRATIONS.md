...
- AI provider is abstracted behind `AIProvider`; current implementation is deterministic provider scaffold.
- Integration registry remains the control plane for provider configuration lifecycle.
