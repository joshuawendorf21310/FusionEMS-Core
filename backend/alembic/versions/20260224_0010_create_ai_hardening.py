...
def upgrade() -> None:
    ...
    op.create_table(
        "ai_policies",
        sa.Column("allow_billing_analysis", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("allow_icd10_suggestions", sa.Boolean(), server_default=sa.text("true"), nullable=False),
