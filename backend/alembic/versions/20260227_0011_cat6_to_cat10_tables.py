...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_template_versions_template_id", "template_versions", [sa.text("(data->>'template_id')")]
    )
    ...
    op.create_index(
        "ix_billing_alert_thresholds_tenant_id", "billing_alert_thresholds", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_conversion_events_funnel_stage",
        "conversion_events",
        [sa.text("(data->>'funnel_stage')")],
    )
    ...
    op.create_index(
        "ix_device_registrations_device_id",
        "device_registrations",
        [sa.text("(data->>'device_id')")],
    )
    op.create_index(
        "ix_device_registrations_status", "device_registrations", [sa.text("(data->>'status')")]
    )
    ...
    op.create_index(
        "ix_push_notifications_status", "push_notifications", [sa.text("(data->>'status')")]
    )
    ...
    op.create_index(
        "ix_user_credentials_status", "user_credentials", [sa.text("(data->>'status')")]
    )
    ...
    op.create_index(
        "ix_production_change_approvals_tenant_id", "production_change_approvals", ["tenant_id"]
    )
