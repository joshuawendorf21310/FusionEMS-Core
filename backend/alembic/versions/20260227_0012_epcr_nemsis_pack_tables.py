...
def upgrade() -> None:
    ...
    op.create_index("ix_nemsis_resource_packs_data", "nemsis_resource_packs", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_nemsis_pack_files_data", "nemsis_pack_files", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_nemsis_ai_explanations_data", "nemsis_ai_explanations", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_nemsis_cs_scenarios_data", "nemsis_cs_scenarios", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_nemsis_patch_tasks_data", "nemsis_patch_tasks", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_event_log_data", "epcr_event_log", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_ai_outputs_data", "epcr_ai_outputs", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_ocr_jobs_data", "epcr_ocr_jobs", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_capture_sessions_data", "epcr_capture_sessions", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_workflow_templates_tenant_id", "epcr_workflow_templates", ["tenant_id"])
    op.create_index("ix_epcr_workflow_templates_data", "epcr_workflow_templates", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_customization_rules_tenant_id", "epcr_customization_rules", ["tenant_id"])
    op.create_index("ix_epcr_customization_rules_data", "epcr_customization_rules", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_form_layouts_data", "epcr_form_layouts", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_agency_branding_data", "epcr_agency_branding", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_picklist_items_data", "epcr_picklist_items", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_chart_workflow_blocks_tenant_id", "epcr_chart_workflow_blocks", ["tenant_id"])
    op.create_index("ix_epcr_chart_workflow_blocks_data", "epcr_chart_workflow_blocks", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_completeness_snapshots_tenant_id", "epcr_completeness_snapshots", ["tenant_id"])
    op.create_index("ix_epcr_completeness_snapshots_data", "epcr_completeness_snapshots", [sa.text("data")], postgresql_using="gin")
    ...
    op.create_index("ix_epcr_sync_conflicts_data", "epcr_sync_conflicts", [sa.text("data")], postgresql_using="gin")
