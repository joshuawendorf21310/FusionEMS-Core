...
def upgrade() -> None:
    ...
    if not _has_table(conn, "document_audit_events"):
        ...
        op.create_index("ix_document_audit_events_entity_id", "document_audit_events", ["entity_id"])
    ...
    if not _has_table(conn, "tenant_provisioning_idempotency"):
        ...
        op.create_index("ix_tenant_provisioning_idempotency_tenant_id", "tenant_provisioning_idempotency", ["tenant_id"])
