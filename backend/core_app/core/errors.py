...
class ErrorCodes:
    ...
    HEMS_INVALID_TRANSITION = "HEMS_INVALID_TRANSITION"
    HEMS_REQUEST_NOT_FOUND = "HEMS_REQUEST_NOT_FOUND"
    AI_OUTPUT_VALIDATION_FAILED = "AI_OUTPUT_VALIDATION_FAILED"
    OCR_UPLOAD_NOT_FOUND = "OCR_UPLOAD_NOT_FOUND"
    OCR_APPROVAL_REQUIRED = "OCR_APPROVAL_REQUIRED"
