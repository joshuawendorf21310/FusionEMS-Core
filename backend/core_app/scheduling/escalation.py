...
def run_coverage_escalations(*, db: Session, tenant_id: uuid.UUID, within_hours: int = 4) -> dict[str, Any]:
    """
    ...
    existing_page_keys = {(p["data"].get("shift_instance_id"), p["data"].get("policy_id")) for p in pages}
