...
down_revision: str | None = "20260224_0003"
    ...
    for name in [
        ...
        if name == "unit_locations":
            op.create_table(
                ...
                sa.Column(
                    "location",
                    postgresql.GEOGRAPHY(geometry_type="POINT", srid=4326),
                    nullable=False,
                ),
                sa.Column(
                    "recorded_at",
            ...
            op.create_index(
                "ix_unit_locations_tenant_recorded",
                "unit_locations",
            ...
            op.create_index(
                "ix_calls_tenant_received", "calls", ["tenant_id", "received_at"], unique=False
            )
        elif name == "units":
            op.create_table(
                "units",
                ...
                sa.Column(
                    "unit_type", sa.String(length=32), nullable=False, server_default="ambulance"
                ),
                sa.Column(
            ...
            op.create_index(
                "ix_claims_tenant_status", "claims", ["tenant_id", "status"], unique=False
            )
        elif name == "documents":
            op.create_table(
                "documents",
            ...
            op.create_index(
                "ix_documents_tenant_type", "documents", ["tenant_id", "doc_type"], unique=False
            )
        else:
