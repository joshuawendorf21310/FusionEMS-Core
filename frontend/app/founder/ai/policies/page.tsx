  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        <div className="micro-caps mb-1">AI Governance</div>
        <h1 className="text-h2 font-bold text-text-primary">AI Governance & Policies</h1>
        <p className="text-body text-text-muted mt-1">Define prompt policies, tone controls, and allowed knowledge domains.</p>
      </div>
