  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-text-primary">AI Thresholds</h1>
        <p className="text-body text-text-muted mt-1">Configure confidence thresholds and escalation rules for AI decisions.</p>
      </div>
