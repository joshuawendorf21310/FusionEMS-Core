  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[rgba(255,107,26,0.6)] mb-1">4 · COMMUNICATIONS</div>
        <h1 className="text-lg font-black uppercase tracking-wider text-white">Broadcast Message Manager</h1>
        <p className="text-xs text-[rgba(255,255,255,0.38)] mt-0.5">Multi-channel broadcast · Per-tenant scheduling · A/B testing</p>
      </div>
