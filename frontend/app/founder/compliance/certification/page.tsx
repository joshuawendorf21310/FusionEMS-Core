  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-lg font-black uppercase tracking-wider text-white">Certification Monitor</h1>
        <p className="text-xs text-[rgba(255,255,255,0.38)] mt-0.5">Renewal tracker · Compliance gap analyzer · Audit package generator</p>
      </div>
