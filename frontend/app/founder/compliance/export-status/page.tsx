  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-text-primary">Export Status</h1>
        <p className="text-body text-text-muted mt-1">Monitor NEMSIS and state export submission status and error logs.</p>
      </div>
