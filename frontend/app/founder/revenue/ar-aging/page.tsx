  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-text-primary">A/R Aging Report</h1>
        <p className="text-body text-text-muted mt-1">Analyze accounts receivable aging buckets with drill-down by payer.</p>
      </div>
