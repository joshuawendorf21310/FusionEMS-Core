  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-text-primary">Access Logs</h1>
        <p className="text-body text-text-muted mt-1">Audit trail of all user access events with filtering and export.</p>
      </div>
