  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        <div className="micro-caps mb-1">Templates</div>
        <h1 className="text-h2 font-bold text-text-primary">Proposal Templates</h1>
        <p className="text-body text-text-muted mt-1">Build proposal templates for service agreements and contract renewals.</p>
      </div>
