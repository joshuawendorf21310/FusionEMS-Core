...
export default {
  ...
  theme: {
    extend: {
      colors: {
        /* Backgrounds — maps to CSS tokens */
        bg: {
      ...
      fontSize: {
        ...
        label:     ["var(--text-label)",    { lineHeight: "var(--leading-tight)", letterSpacing: "var(--tracking-label)", fontWeight: "600" }],
        micro:     ["var(--text-micro)",    { lineHeight: "var(--leading-tight)", letterSpacing: "var(--tracking-micro)", fontWeight: "500" }],
      },
